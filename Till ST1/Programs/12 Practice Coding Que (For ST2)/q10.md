...
*/
    public static void main(String ... args){
        ...
        for(int i=0; i < size; i++){
            ...
            // check if player can destroy pillar1 ? (playerScore*x) == pillar1Score
            int x = pillar1Score/playerScore;
            if(playerScore*x == pillar1Score){

                // check if player can destroy pillar2 ?
                x = pillar2Score/playerScore;
                if(playerScore*x == pillar2Score){
                    System.out.println(playerScore); // this player can destroy both pillars
                    ansFound = true;
                }
            } 
        }
